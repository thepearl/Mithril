...
public extension AnimationPreset {
    ...
    static let fadeInUp = AnimationPreset(steps: [
    ...
    /// Slide in from left
    static let slideInLeft = AnimationPreset(steps: [
        .slideIn(direction: .left, distance: 300, duration: 0.5)
    ])
    
    /// Zoom in with bounce
    static let zoomIn = AnimationPreset(steps: [
        .scaleFrom(from: 0.0, to: 1.1, duration: 0.3),
        .scaleFrom(from: 1.1, to: 1.0, duration: 0.2)
    ])
    
    /// Bounce entrance
    static let bounceIn = AnimationPreset(steps: [
    ...
    /// Rotate in
    static let rotateIn = AnimationPreset(steps: [
...
public extension AnimationPreset {
    /// Fade out to bottom
    static let fadeOutDown = AnimationPreset(steps: [
    ...
    /// Slide out to right
    static let slideOutRight = AnimationPreset(steps: [
        .slideOut(direction: .right, distance: 300, duration: 0.5)
    ])
    
    /// Zoom out
    static let zoomOut = AnimationPreset(steps: [
...
public extension AnimationPreset {
    ...
    static let bounce = AnimationPreset(steps: [
        .scaleFrom(from: 1.0, to: 1.1, duration: 0.2),
        .scaleFrom(from: 1.1, to: 1.0, duration: 0.2)
    ])
    
    /// Flash opacity
    static let flash = AnimationPreset(steps: [
    ...
    /// Pulse scale
    static let pulse = AnimationPreset(steps: [
        .pulse(scale: 1.1, duration: 0.5)
    ])
    
    /// Shake horizontally
    static let shake = AnimationPreset(steps: [
        .shake(direction: .horizontal, intensity: 10, duration: 0.6)
    ])
    
    /// Wobble rotation
    static let wobble = AnimationPreset(steps: [
    ...
    /// Heartbeat pulse
    static let heartbeat = AnimationPreset(steps: [
...
public extension AnimationPreset {
    ...
    /// List item entrance
    static let listItem = AnimationPreset(steps: [
